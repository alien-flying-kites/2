...
export default Vue.extend({
  ...
  computed: {
    ...mapGetters(['serverData', 'operateData', 'courseAdminOptionList'])
  },
  watch: {
  ...
  methods: {
    modifyAccount () {
      ...
      this.$store.dispatch('updateCourse', content)
      // this.$socket.emit('updateCourse', content)
    },
    initData (val: any) {
      this.coursename = val.name || null
