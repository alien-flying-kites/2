<template>
  <q-page class="">
    <div class="q-pa-sm q-mt-sm q-ml-sm">
      <q-breadcrumbs>
        <q-breadcrumbs-el label="我的课程" to="/myCourse"/>
      </q-breadcrumbs>
    </div>
    <div class="q-pa-sm">
      <q-table
      ...
      >
        ...
        <template slot="body" slot-scope="props">
          <q-tr :props="props">
            ...
            <!-- <q-td key="role" :props="props">{{ props.row.displayName?props.row.displayName:'--'}}</q-td> -->
            <!-- <q-td key="status" :props="props">
              {{ props.row.isActive?(props.row.isActive===false?"已冻结":"已激活"):"未激活"}}
              <q-icon name="close" color="negative" v-if="props.row.isActive===false"/>
              <q-icon name="done" color="positive" v-if="props.row.isActive===true"/>
            </q-td> -->
...
export default Vue.extend({
  ...
  methods: {
    ...
    request (props:any) {
      ...
      this.$store.dispatch('getMyCourse', params)
      this.hideLoading()
    },
