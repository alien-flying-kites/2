<template>
  <q-page class="">
    <div class="q-pa-sm q-mt-sm q-ml-sm" style="display:block">
      <!-- <q-breadcrumbs class="top-left">
        <q-breadcrumbs-el label="我的授课班级" to="/myTeachClass"/>
      </q-breadcrumbs> -->
      <q-breadcrumbs>
         <span class="title"> 我的授课班级</span>
         <span class="title top-right" @click="forward()" >查看服务器连接</span>
      </q-breadcrumbs>
      <!-- <q-breadcrumbs class="top-right">
        <q-breadcrumbs-el label="查看服务器连接" to="/myTeachClass"/>
      </q-breadcrumbs> -->
    </div>
    <div class="q-pa-sm">
      <q-table
...
export default Vue.extend({
  ...
  methods: {
    ...
    request (props:any) {
      ...
      // console.log(params)
      if (params.id) {
        this.$store.dispatch('getMyTeachClass', params)
        this.hideLoading()
      } else {
      }
    },
